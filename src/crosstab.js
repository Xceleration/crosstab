...
(function(window, define) {
  define('crosstab', function(require, exports, module) {
    ...
    var isSafari = /^((?!chrome|android).)*safari/i.test(useragent.toLowerCase());
    ...
    function notSupported() {
      ...
      if (isMobile) {
        reasons.push('mobile browser detected');
      }
    ...
    crosstab.supported = !!localStorage && window.addEventListener && setItemAllowed && !isSafari && !isMobile;
    crosstab.util = util;
